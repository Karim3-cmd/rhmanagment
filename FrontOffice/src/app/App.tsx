...
export default function App() {
  ...
  if (currentView === 'login') {
    pageContent = <Login onLogin={handleLogin} onSwitchToSignup={() => setCurrentView('signup')} />;
  } else if (currentView === 'signup') {
    pageContent = <Signup onSignup={handleSignup} onSwitchToLogin={() => setCurrentView('login')} />;
  } else {
    pageContent = user ? <Dashboard user={user} onLogout={handleLogout} /> : null;
  }
